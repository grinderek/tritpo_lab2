...
Для компаний, которые берут сторонние проекты, необходимо выгодно 
...
## 1.3 Аналоги
Сanva — сервис, позволяющий создавать резюме, используя различные шаблоны. Доступен в виде веб-сайта, присутствует платная подписка для использования всех имеющихся видов резюме в приложении.
